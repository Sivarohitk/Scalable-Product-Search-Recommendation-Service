...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark recommendations latency.")
...
def main() -> None:
    ...
    summary = run_get_benchmark(
        ...
        path=f"/recommendations/{args.product_id}",
    ...
    print_summary(
        summary,
        details=f"product_id={args.product_id} limit={args.limit}",
    )
